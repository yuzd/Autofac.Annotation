...
namespace Castle.DynamicProxy
{
    ...
    internal class AsyncDeterminationInterceptor : IInterceptor
    {
        ...
        /// </summary>
        /// <param name="asyncInterceptor">The underlying <see cref="IAsyncInterceptor"/>.</param>
        ...
        /// </summary>
        public IAsyncInterceptor Interceptor { get; }
        ...
        public void Intercept(IInvocation invocation)
        {
            ...
            switch (methodType)
            {
                ...
                case MethodType.AsyncFunction:
                    GetHandler(invocation.Method.ReturnType).Invoke(invocation, Interceptor);
                    return;
                default:
