...
//             TInterface target,
//             params AsyncInterceptor[] interceptors)
//             where TInterface : class
//         {
//             return proxyGenerator.CreateInterfaceProxyWithTarget(target, interceptors);
//         }
//
//         /// <inheritdoc cref="IProxyGenerator.CreateInterfaceProxyWithTarget{TInterface}(TInterface, IInterceptor[])" />
//         public static TInterface CreateInterfaceProxyWithTarget<TInterface>(
...
//             where TInterface : class
//         {
//             return proxyGenerator.CreateInterfaceProxyWithTarget(target, options, interceptors);
//         }
//
