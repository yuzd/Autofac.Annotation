...
public class AnotationTest
{
    ...
    public void Test_Type_10()
    {
        ...
        container.TryResolveKeyed("aa14", typeof(B), out var aa);
        Assert.Null(aa);
    ...
    public void Test_Type_28()
    {
        ...
        var exception = Assert.Throws<DependencyResolutionException>(() => { container.Resolve<A31>(); });
...
////            builder.RegisterType(typeof(A323)).As(new TypedService(typeof(A3122)));
    ...
    public void Test_Type_33()
    {
        ...
        var resolve = container2.Resolve<A37>();
    ...
    public void Test_Type_36()
    {
        ...
        var ss = a39.A38.GetObject();
        Thread.Sleep(100);
        var ss2 = a39.A38.GetObject();
    ...
    public void Test_Type_43()
    {
        ...
        var container = builder.Build();
        var testCircular3 = container.Resolve<TestCircular3>();
        Assert.NotNull(testCircular3);
        Assert.NotNull(testCircular3.TestCircular4);
        Assert.NotNull(testCircular3.TestCircular4.TestCircular3);
    }
