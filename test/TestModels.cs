...
public class A10
{
    public A10([Value("${a10}")] string school, [Value("${list}")] int[] list, [Value("#{${dic}}")] Dictionary<string, string> dic,
        [Value("")] int dddd)
    {
        School = school;
        this.list = list;
...
public class A15
{
    [Value("${a9}")] public string test = "t";

    [Value("${a9}")] public string School { get; set; } = "A14";
}

[Component]
public class A16
{
    [Autowired("A13")] public B b1;
    public string School { get; set; } = "A16";

    [Autowired] public B B { get; set; }
}

[Component]
public class A17
{
    [Autowired("A131111")] public B b1;
...
public class A19
{
    ...
    [Autowired("A13", Required = false)] public B b2 { get; set; }
...
public class A23 : IA23
{
    ...
    [Autowired] public A21 A21 { get; set; }
...
public class A25
{
    ...
    [Autowired] public IA23 A23 { get; set; }
}

public class A26
{
    [Autowired] private IA23 A23;
}
...
public class A27
{
    [Value("aaaaa")] public string Test { get; set; }
}

[Component(AutofacScope = AutofacScope.SingleInstance)]
public class A272
{
    [Autowired] public A27 a27;
}
...
public class A30
{
    ...
    private void start(IComponentContext context)
    {
        Test = "bbbb";
...
public class A31
{
    [Autowired("A311")] public A311 A311 { get; set; }
}
...
public class A32
{
    [Autowired()] public IList<A3122> A31List { get; set; }
}

[Component]
public class A33
{
    [Autowired("A3213")] public IEnumerable<A3122> A31List { get; set; }
}

[Component]
public class A34
{
    [Autowired] public IEnumerable<Lazy<A3122>> A31List { get; set; }
}

[Component]
public class A35
{
    [Autowired("A3213")] public IEnumerable<Lazy<A3122>> A31List { get; set; }
}
...
{
    [Autowired("A3612")] public A36 A3612 { get; set; }
...
{
    [Autowired] public A38 A38 { get; set; }
...
public class A37
{
    [Autowired("A3611")] public A36 A36 { get; set; }
}

[Component]
public class A38
{
    [Autowired("A3612")] public A36 A36 { get; set; }

    [Autowired("A3611")] public A36 A3611 { get; set; }

    [Autowired] public A37 A37 { get; set; }
...
public class A39
{
    ...
    [Autowired] public ObjectFactory<A38> A38 { get; set; }
}
...
{
    [Autowired] public ITestAutowiredModal abc { get; set; }

    [Autowired] public ITestAutowiredModal def { get; set; }
}

[Component(AutofacScope = AutofacScope.SingleInstance)]
public class TestAutowiredModal4
{
    [Autowired] public ObjectFactory<ITestAutowiredModal> abc { get; set; }

    [Autowired] public ObjectFactory<ITestAutowiredModal> def { get; set; }
}

[Component]
public class TestLazyModel1
{
    [Autowired] public Lazy<TestAutowiredModal4> TestAutowiredModal4 { get; set; }

    [Autowired] public TestAutowiredModal3 TestAutowiredModal3 { get; set; }
}

[Component]
public class TestCircular1
{
    [Autowired] public TestCircular2 TestCircular2 { get; set; }
}

[Component]
public class TestCircular2
{
    [Autowired] public TestCircular1 TestCircular1 { get; set; }
}

[Component]
public class TestCircular3
{
    [Autowired] public TestCircular4 TestCircular4 { get; set; }
}

[Component]
public class TestCircular4
{
    [Autowired] public TestCircular3 TestCircular3 { get; set; }
}

[Component]
public class LazyModel1
{
    [Autowired] public Lazy<LazyModel2> LazyModel2 { get; set; }
}
